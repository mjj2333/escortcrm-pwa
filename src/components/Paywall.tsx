...
interface GiftCode {
  hash: string
  expiresAt?: string  // ISO date string — if set, access expires on this date
}

const GIFT_CODES: GiftCode[] = [
  { hash: '22b70cf5f3c48d73f301cb49e00b43604b3bff75be01319ce42a7cb2b1574e8a' }, // 001
  { hash: '7ff50e40fc16aaca1dd462c9310b97db4e3455bef6ca8597f6d79d96b80b6f5d' }, // 002
  { hash: 'e17feea8d0336808d0626211d4329641363aea251f6cf272826d99b922f73e4b' }, // 003
  { hash: 'fc5f03e446befb2b4dff21986943b8e987056056f806a6af7d9354f83a2a476c' }, // 004
  { hash: 'ad93e9abe2968f813af1a63ab8f1f811a6771a8fe54f8cdce7db4706fb6cd8ec' }, // 005
  { hash: '064ed653d8255f22b85ef34d3d4d7ba4e0f9a2fcce6146df670d1eeb0d734e8c' }, // 006
  { hash: '01139000e917e30c9833c6008e37a1c5b237a00fc1d928d7bd617d169795442d' }, // 007
  { hash: '47936b5c1a7baef51aef96db4039a30a32ee5b3b29b3992625bf85e04ca91713' }, // 008
  { hash: '7c2d0b10df6053d2748bfc9a8767a062e2024509a9b6f527665bc2309e818767' }, // 009
  { hash: 'cd0690feb7fa9c4ee2a287d22e2c5da02557e35cec6cd947af914c9d4ec174ac' }, // 010
]
...
async function matchGiftCode(code: string): Promise<GiftCode | null> {
  const hash = await hashCode(code)
  return GIFT_CODES.find(g => g.hash === hash) || null
}
