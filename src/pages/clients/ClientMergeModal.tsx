...
function buildMergeFields(source: Client, target: Client): MergeField[] {
  ...
  add('screeningStatus', 'Screening', source.screeningStatus, target.screeningStatus,
    ...
    (['Verified', 'In Progress', 'Pending', 'Declined'] as const).indexOf(source.screeningStatus) <
    (['Verified', 'In Progress', 'Pending', 'Declined'] as const).indexOf(target.screeningStatus)
      ? 'source' : 'target')
